...
def detailManga(fullname):
    ...
    if chapterlink is not None:
        for link_chapter_thuong in soup_DetailManga.find_all('a', class_='chapter_list_a'):
            ...
            full_chapter_detail = get_All_anh_cua_tung_trang(link_thuong,full_detail)
        ...
        for link_tren_18 in soupcheck.find_all('a', class_='chapter_list_a'):
            ...
            full_chapter_detail = get_All_anh_cua_tung_trang(link_18_10,full_detail)
        ...
        if li is not None:
            for li2 in ul. find_all('li'):
                for dd in li2.find_all('dl', class_='bookinfo'):
                    ...
                    manga_search['Link_manga'] = dd.find('a', class_='bookname').get('href')
...
if __name__ == "__main__":
   app.run(host='0.0.0.0',port=86666)
