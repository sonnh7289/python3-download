...
def createcomment():
    ...
    imageattach = request.headers.get("imageattach")
    thong_tin={}
    list_thong_tin=[]
    config = {
                'user': 'leooRealman',
    ...
    try:
        ...
        lenhquery = """INSERT INTO comment(id_Comment,noi_dung_Comment,IP_Comment,device_Comment,id_toan_bo_su_kien,imageattach) values(%d,%s,%s,%s,%s,%s)"""
        # sql = f"INSERT INTO comment VALUES ( {idNext}, %s, %d, %s , %s , %s )"
        print(idNext)
        val = (idNext,noi_dung , id_toan_bo_su_kien,ipComment , device_cmt,imageattach)
