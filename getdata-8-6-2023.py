...
def createcomment():
    ...
    try:
        ...
        lenhquery = f"INSERT INTO comment(id_Comment,noi_dung_Comment,IP_Comment,device_Comment,id_toan_bo_su_kien,imageattach) VALUES ( {idNext} ,%s,%s,%s, {id_toan_bo_su_kien} ,%s)"
...
def getPageLoveHistory(trang):
    ...
    try:
        ...
        for idItemPhanTu in range(0, soPhanTu):
            Mot_LanQuerryData = []
...
#            print(saved_sukien)
            ...
            for i in range(trang * 25, trang * 25 + 25):
