...
def get_movie():
    ...
    for diem in soup.findAll('div', class_='metascore_w large no_tbd movie mixed'):
        diems={}
        diems['span']=diem.text
        listdData.append(diems)
    return listdData    
...
def get_tv():
    ...
    for itemmeta in soup.findAll('div', class_='col main_col'):
        ...
        ItemJson['text'] = itemmeta.text
        listdData.append(ItemJson)
    # for spans in soup.findAll('td', class_='nopad'):
    #     texts={}
    #     texts['span']=spans.text
        # listdData.append(texts)
...
def get_review():
    ...
    for fxdrow2 in soup.findAll('div', class_='fxdrow'):
        ...
        ItemJson2['imgesa'] = fxdrow2.img['src']
        ItemJson2['text'] = fxdrow2.text
        listdData.append(ItemJson2)
    # for imgsd in soup.findAll('div', class_='review pad_top2 pad_btm2'):
    #     ItemJson6 = {}
    #     ItemJson6['imgesa'] = imgsd.img['src']
